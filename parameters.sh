...
#define u_samplePattern				(u_params[25].z)
#define u_lobeRotation				(u_params[25].w)
...
#define u_lobeCount					(u_params[27].x)
#define u_lobeRadiusMin				(u_params[27].y)
#define u_lobeRadiusDelta2x			(u_params[27].z)
